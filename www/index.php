<?php
    ...
    if(isset($_GET['clickedname'])){
        $_SESSION['clickedname'] = $_GET['clickedname'];
...
<?php
    ...
    while(!feof($file))
    {
        ...
        if(isset($_POST["searchbtn"])){
            if (str_contains(strtolower($name), strtolower($_POST["keyword"])) == FALSE){
            continue;
        }
    }
        if ($name === ""){
        ...
        <div class='col-lg-4 col-md-6 col-sm-12 mx-product'>
            <div class='product-item card text-center'>
                <a href='?clickedname=";echo $name; echo" '><img src='$pimage'></a>
                <h4><a href='?clickedname=";echo $name;echo"'>'$name'</a></h4>
