        ...
        <div class="info">
                ...
                <fieldset>
                    <form method = "post" enctype="multipart/form-data">
                        ...
                        <label for="">Select your distribution hub:</label>
                        <div class="hub">
                            <div class= "hanoi_hub">   
                                <input type="radio" name = "chosenhub" id="Hanoi Hub" value = "Hanoi">
                                <label for="Hanoi Hub">Name: Hanoi Distribution Hub</label>
                                <a>-  Address: Handi Resco Building, 521 Kim Mã, Ngọc Khánh, Ba Đình, Hanoi</a>
                            </div> 

                            <div class="hmc_hub">
                                <input type="radio" name = "chosenhub" id="Ho Chi Minh Hub" value = "HCMC">
                                <label for="Ho Chi Minh Hub">Name: HCMC Distribution Hub</label>
                                <a>-  Address: 702 Nguyễn Văn Linh, Tân Hưng, Quận 7, Thành phố Hồ Chí Minh</a>
                            </div>

                            <div class = "danang_hub">
                                <input type="radio" name = "chosenhub" id="Da Nang Hub" value = "Danang">
                                <label for="Da Nang Hub">Name: Da Nang Distribution Hub</label>
                                <a>-   Address: Số 02 Đ. 2 Tháng 9, Bình Hiên, Hải Châu, Đà Nẵng</a>
                            </div>
                        </div>
...
<?php
                            ...
                            if(isset($_POST["act"])){
                                if(isset($_POST["username"]) && isset($_POST["password"]) && isset($_POST["chosenhub"]) && isset($_FILES['avt']['tmp_name']) )
                                {
                                    ...
                                    echo "Please input all your information!";
                                }
                            }
?>
